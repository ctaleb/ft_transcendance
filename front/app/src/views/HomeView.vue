...
export default defineComponent({
	data: () => {
		return {
			...
			password: "",
			url_custom:
				"https://api.intra.42.fr/oauth/authorize?client_id=1a90768d9956eae0b0360b4588273a1d4a25143a9c8cfc6a0330dac17b9684db&redirect_uri=http%3A%2F%2F" +
				window.location.hostname +
				"%3A3000%2F&response_type=code",
			token: {
				access_token: null,
				token_type: null,
				expires_in: null,
